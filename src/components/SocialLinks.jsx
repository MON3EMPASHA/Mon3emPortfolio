...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/abdelmonem-hatem/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@Mon3em_",
    icon: Instagram,
    url: "https://www.instagram.com/abdelmonem_hatem/",
    color: "#E4405F",
  ...
  },
  {
    ...
    subText: "@MON3EMPASHA",
    icon: Github,
    url: "https://github.com/MON3EMPASHA",
    color: "#ffffff",
    gradient: "from-[#1e3a8a] to-[#3b82f6]",
  },
];
  ...
  return (
    <div className="w-full bg-gradient-to-br from-white/10 to-white/5 rounded-2xl p-6 py-8 backdrop-blur-xl">
      <h3 className="text-xl font-semibold text-white mb-6 flex items-center gap-2">
        <span className="inline-block w-8 h-1 bg-[#1e3a8a] rounded-full"></span>
        Connect With Me
      </h3>
