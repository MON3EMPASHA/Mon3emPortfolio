...
import img from "../assets/Mana3emo.jpeg";
...
const Header = memo(() => (
  <div className="text-center lg:mb-8 mb-2 px-[5%]">
    <div className="inline-block relative group">
      <h2
        className="text-4xl md:text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#1e3a8a] to-[#3b82f6]"
        data-aos="zoom-in-up"
...
StatCard.propTypes = {
  icon: PropTypes.elementType.isRequired, // Validate that 'icon' is a valid React component
  color: PropTypes.string.isRequired, // Validate that 'color' is a string
  value: PropTypes.oneOfType([PropTypes.string, PropTypes.number]).isRequired, // Validate that 'value' is a string or number
  ...
  animation: PropTypes.string, // Validate that 'animation' is a string (optional)
};
